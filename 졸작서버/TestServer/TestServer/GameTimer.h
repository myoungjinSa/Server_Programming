...
//
//
//	std::chrono::steady_clock::time_point m_nStart;
//
//	std::chrono::steady_clock::time_point m_nCurrentTime;
//	std::chrono::steady_clock::time_point m_nLastFrameTime;
//
//	std::chrono::steady_clock::time_point m_nTotalElapsedTime;
//
//	//int64_t								
//	
//};
